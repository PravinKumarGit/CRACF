...
export default class RentVsBuyCalculator extends Component {
  ...
  createOwnerLenderEscrowPicker() {
    ...
    console.log('escrowfee 1 ' + escrowFee);
  ...
  createEscrowPicker(idx, value) {
    ...
    console.log('escrow fee 2 ' + escrowFee);
    console.log('owner fee 2 ' + this.state.ownerFee);
    escrowTotal = (
    ...
    this.setState(
      {escrowPolicyType: value, escrowFee: escrowFee, escrowTotal: escrowTotal},
      this.calTotalMonthlyPayment,
    );
  }
  ...
  createOwnerPicker(idx, value) {
    ...
    this.setState(
      {ownerPolicyType: value, ownerFee: ownerFee, escrowTotal: escrowTotal},
      this.calTotalMonthlyPayment,
    );
  }
  ...
  createLenderPicker(idx, value) {
    ...
    this.setState(
      {lenderPolicyType: value, lenderFee: lenderFee},
      this.calTotalMonthlyPayment,
    );
  }
  ...
  callBuyerProrationSettingApi() {
    console.log('county id callBuyerProrationSettingApi ' + this.state.county);
    console.log('state id callBuyerProrationSettingApi ' + this.state.state);
    ...
    callPostApi(
      ...
      //console.log("buyer_proration_setting rent v/s buy " + JSON.stringify(result));
      ...
      console.log(
        'prorationLength callBuyerProrationSettingApi rent v/s buy ' +
          prorationLength,
      );

      if (prorationLength == 2 && this.state.state != 2) {
        console.log('in if cond callBuyerProrationSettingApi rent v/s buy ');
        this.setState({
  ...
  onChangeDisc(text, flag) {
    ...
    this.setState(
      {disc: discText, discAmt: amrt.discount},
  ...
  onChangeRate(text, flag) {
    //	console.log("onChangeRate text " + text);
  ...
  onChangeRateStep(text, flag) {
    ...
    if (this.state.tab == 'CONV') {
      ...
      if (flag == 'ltv2') {
        if (this.state.downPaymentFixed == true) {
          ...
          resaleConventionalLoanLTV = (
            (conv_amt.amount / this.state.sale_pr_calc) *
            100
          ).toFixed(2);
    ...
    callGetApi(
      ...
      if (this.state.tab == 'FHA') {
        ...
        //console.log("getAdjustedVA Resp " + JSON.stringify(resp));
        ...
        console.log(
          'getVaFundingFinance Resp ' + JSON.stringify(responsePrepaid),
        );
        ...
        console.log('adjusted_loan_amt ' + responsePrepaid.adjusted);
      ...
      if (
        ...
        if (
          ...
          responresp_mon_taxse = useAnnualTaxforPrepaid(data_mon_tax);
  ...
  changeMonTaxPrice() {
    ...
    console.log('changeMonTaxPrice req rent vs buy ' + JSON.stringify(data));
    ...
    console.log('resp changeMonTaxPrice rent vs buy ' + JSON.stringify(resp));
    ...
    console.log('req changeMonTaxPrice rent v/s buy ' + JSON.stringify(req));

    //calling method to calculate the discount amount
    responseRealEstate = getRealEstateTaxes(req);

    console.log(
      'responseRealEstate changeMonTaxPrice rent v/s buy ' +
    ...
    console.log(
      'realEstateTaxesRes changeMonTaxPrice rent v/s buy ' +
  ...
  callGlobalSettingApiOnDateChange() {
    console.log('callGlobalSettingApiOnDateChange');
  ...
  afterSetStateSettingApi() {
    ...
    if (this.state.tab == 'FHA') {
      ...
      if (this.state.downPaymentHidden > 0) {
        ...
        resaleConventionalLoanLTV = (
          (amount / this.state.sale_pr_calc) *
          100
        ).toFixed(2);
        this.setState({
  ...
  calTotalMonthlyPayment() {
    ...
    console.log(
      'requestTotPreItem rent v/s buy ' + JSON.stringify(requestTotPreItem),
    );
  ...
  calFinalFunction() {
    ...
    console.log(
      'ten_years_sp_array ' + JSON.stringify(this.state.ten_years_sp_array),
    );
    ...
    if (this.state.ten_years_sp_array.length == 11) {
      for (let i = 0; i < this.state.ten_years_sp_array.length; i++) {
        ...
        console.log(
          'ten_years_sp_array 1  ' + this.state.ten_years_sp_array[i + 1],
        );
  ...
  downPaymentChange(downPayment) {
    ...
    resaleConventionalLoanLTV = parseFloat(resaleConventionalLoanLTV).toFixed(
      2,
    );
    this.setState(
      {downPaymentFixed: true, ltv: resaleConventionalLoanLTV},
      this.callSalesPr,
    );
    //creating object for origination fee and amount
  }
                          ...
                          <CustomTextInput
                            ...
                            onEndEditing={event =>
                              this.updateFormField(
                                event.nativeEvent.text,
                                'down_payment',
                                this.downPaymentChange(event.nativeEvent.text),
                              )
                            }
                    ...
                    <View style={{width: '90%', flexDirection: 'row'}}>
                      <TextInput
                        ...
                        onChangeText={value =>
                          this.setState({
                            to_email: value,
                            to_email_default: value,
                          })
                        }
                        value={this.state.to_email.toString()}
                      />
                    </View>
                  </View>
