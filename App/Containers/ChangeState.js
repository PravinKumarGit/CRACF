...
export default class ChangeState extends Component {
  ...
  callVerifyZipCodeApi() {
    ...
    if (
      ...
      this.state.County == 'Select County'
    ) {
          ...
          <View style={Styles.FieldContainer}>
            <View style={[Styles.field, {marginTop: 10}]}>
              ...
              <TouchableOpacity
                ...
                onPress={this.StatePicker.bind(this)}>
                <View style={Styles.dropdownfieldview}>
                  <Text style={Styles.dropdownfieldviewtext}>
                    {this.state.State}
                  </Text>
                  <Image
            ...
            <View style={Styles.field}>
              ...
              <TouchableOpacity
                style={Styles.dropdownto}
                onPress={this.CountyPicker.bind(this)}>
                <View style={Styles.dropdownfieldview}>
                  <Text style={Styles.dropdownfieldviewtext}>
                    {this.state.County}
                  </Text>
            ...
            <View style={Styles.field}>
              ...
              <TouchableOpacity style={Styles.dropdownto}>
                <TextInput
                  ...
                  onChangeText={zipcodeval =>
                    this.setState({ZipCode: zipcodeval})
                  }
                  onSubmitEditing={() => {
                    this.callVerifyZipCodeApi();
                  }}
