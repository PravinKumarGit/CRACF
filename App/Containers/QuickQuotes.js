...
export default class QuickQuotes extends Component {
    ...
    if (response == '1') {
      ...
      AsyncStorage.getItem('userDetail')
        .then(value => {
          ...
          if (newstr.state == '26' && newstr.county == '1531') {
  ...
  callGetCountyApi(IDofState) {
    ...
    callPostApi(GLOBAL.BASE_URL + GLOBAL.Get_County, {
      ...
      for (let i = 0; i < this.state.countryArray.length; i++) {
        ...
        if (
          i + 1 == this.state.countryArray.length &&
          this.state.stateId == '2'
        ) {
          this.state.countItems.push(
            {key: '3153', label: 'HOMER'},
  ...
  callSendEmailFunc() {
    ...
    if (this.state.invalidEmailStatus == true) {
      ...
      Alert.alert(
        '',
        'Please enter valid email addresses with comma separated!',
      );
      ...
      callPostApi(
        GLOBAL.BASE_URL + GLOBAL.Get_Quick_Qoute_Pdf,
        quickQuotesData,
  ...
  onCallSaleSection() {
    ...
    if (this.state.salePrice == '' || this.state.salePrice == '0.00') {
      ...
      this.state.user_county == '' ||
      this.state.user_county == 'Select county'
    ) {
      this.setState({
        countryError: true,
      });
      ...
      callPostApi(
        GLOBAL.BASE_URL + GLOBAL.quick_quotes_get_sale_data,
        {
          county_name: this.state.user_county,
          state_name: this.state.user_state,
          salePrice: this.state.salePrice,
          adjusted: this.state.loanAmount,
          userId: this.state.user_id,
          device: this.state.deviceName,
          reissueyr: this.state.reissueYearCheckBoxVal,
        ...
        if (result.status == 'success') {
          console.log(
            'sale resp result in quick quotes ' + JSON.stringify(result),
          );
  ...
  onCallRefinanceSection() {
    ...
    if (
      this.state.refineLoanAmount == '' ||
      this.state.refineLoanAmount == '0.00'
    ) {
      this.dropdown.alertWithType(
        'error',
        'Error',
      ...
      this.setState({animating: 'true'});
      callPostApi(
        GLOBAL.BASE_URL + GLOBAL.quick_quotes_get_refi_data,
        {
          county_name: this.state.user_county,
          state_name: this.state.user_state,
          adjusted: this.state.refineLoanAmount,
          userId: this.state.user_id,
          device: this.state.deviceName,
          zipcode: this.state.zip,
          reissueyr: '0',
  ...
  onPressEmailIcon() {
    ...
    if (
      ...
      this.state.salePrice != '0.00' &&
      this.state.saleStatus == true &&
      this.state.calculateStatus == true
    ) {
      this.setEmailModalVisible(!this.state.emailModalVisible);
    } else if (
      this.state.refineLoanAmount !== '' &&
      this.state.refineLoanAmount !== '0.00' &&
      this.state.saleStatus == false &&
      this.state.calculateStatus == true
    ) {
      this.setEmailModalVisible(!this.state.emailModalVisible);
    } else {
      this.dropdown.alertWithType(
        'error',
        'Error',
        'Please complete calculation first...',
      );
    }
  }
  ...
  render() {
    ...
    if (
      ...
      this.state.openMessagePopup == false
    ) {
      showable = (
        <View style={{flex: 1}}>
          ...
          <View style={QuickQuotesStyle.HeaderContainer}>
            <Image
              style={QuickQuotesStyle.HeaderBackground}
              source={Images.header_background}></Image>
            <TouchableOpacity
              style={{width: '20%'}}
              onPress={this.goHomePage.bind(this)}>
              <Image
                style={QuickQuotesStyle.back_icon}
                source={Images.back_icon}
              />
            </TouchableOpacity>
            <Text style={QuickQuotesStyle.header_title}>
              {STRINGS.t('Quick_Quotes')}
            </Text>
            <View
              style={{
              ...
              {this.state.saleStatus == true ? (
                <View style={QuickQuotesStyle.ConditionalContainer}>
                  <View>
                    <View style={QuickQuotesStyle.ButtonViewStyle}>
                      <Button
                        onPress={this.sales.bind(this)}
                        style={QuickQuotesStyle.ButtonStyle}>
                        <Text style={QuickQuotesStyle.ButtonWhiteTextStyle}>
                          {STRINGS.t('QuickQuotesSale')}
                        </Text>
                      </Button>
                      <Button
                        onPress={this.refinance.bind(this)}
                        style={QuickQuotesStyle.ButtonWhiteStyle}>
                        <Text style={QuickQuotesStyle.ButtonBlueTextStyle}>
                          {STRINGS.t('QuickQuotesRefin')}
                        </Text>
                      </Button>
                    </View>
                  ...
                  <View>
                    <View style={QuickQuotesStyle.TabsMainContainer}>
                      <View style={QuickQuotesStyle.IndivTabContainer}>
                        <Text style={[QuickQuotesStyle.IndivTabSpTextStyle]}>
                          {STRINGS.t('Quick_Quote_Sale_Price')}
                        </Text>
                        <View
                          style={QuickQuotesStyle.IndivTabTextInputViewStyle}>
                          <Text
                            style={{
                              width: '6%',
                              alignSelf: 'center',
                          ...
                          <CustomTextInput
                            ...
                            onChangeText={value =>
                              this.setState({salePrice: this.onChange(value)})
                            }
                            value={this.delimitNumbers(this.state.salePrice)}
                            style={{
                              width: '94%',
                              marginTop: 6,
                              height: 36,
                      ...
                      <View style={QuickQuotesStyle.IndivTabContainer}>
                        <Text style={QuickQuotesStyle.IndivTabLaTextStyle}>
                        ...
                        <View
                          ...
                          <CustomTextInput
                            ...
                            underlineColorAndroid={'transparent'}
                            onChangeText={value =>
                              this.setState({loanAmount: this.onChange(value)})
                            }
                      ...
                      <View
                        style={[
                          QuickQuotesStyle.IndivTabContainer,
                          {marginTop: 20},
                        ]}>
                        <Text style={QuickQuotesStyle.drpDownLabel}>
                          {STRINGS.t('Quick_Quotes_State_County')}
                        </Text>
                        <View style={QuickQuotesStyle.dropdwnContainer1}>
                          <ModalSelector
                            data={this.state.srvItems}
                            initValue={this.maxLength(
                              this.state.state_name_drop_down,
                            )}
                            onChange={option =>
                              this.onChangeState(option)
                            }></ModalSelector>
                        </View>
                        <View style={QuickQuotesStyle.dropdwnContainer2}>
                          {this.state.countryError == false ? (
                            <ModalSelector
                              ...
                              initValue={this.maxLength(
                                this.state.county_name_drop_down,
                              )}
                              onChange={option =>
                                this.onChangeCounty(option)
                              }></ModalSelector>
                          ) : (
                            <ModalSelector
                              data={this.state.countItems}
                      ...
                      <View style={QuickQuotesStyle.IndivTabContainer}>
                        ...
                        <View
                          style={[
                            QuickQuotesStyle.IndivTabTextInputViewStyle,
                            this.state.stateId == 12 ||
                            this.state.stateId == 23 ||
                            this.state.showNewJerseyCheckBox == true ||
                            this.state.joplinCityNJChk == true
                              ? {width: '30%'}
                              : {width: '60%'},
                          ]}>
                          <CustomTextInput
                            ...
                            underlineColorAndroid={'transparent'}
                            onChangeText={value =>
                              this.setState({zip: this.onChange(value)})
                            }
                            value={this.delimitNumbers(this.state.zip)}
                            style={{
                              width: '94%',
                              marginTop: 2,
                              height: 36,
                        ...
                        {renderIf(this.state.stateId == 12)(
                          <View>
                            <View
                              style={
                                QuickQuotesStyle.IndivTabCheckBoxViewStyleqq
                              }>
                              <CheckBox
                                title="HARPTA"
                                right={true}
                                uncheckedColor="#3b90c4"
                                containerStyle={{
                                ...
                                center
                                checkedColor="#3b90c4"
                                checked={this.state.isCheckForHARPTA}
                                onPress={this.handlePressCheckedBoxForHARPTA}
                              />
                            </View>
                          </View>,
                        )}
                          ...
                          <View>
                            <View
                              ...
                              <CheckBox
                                ...
                                center
                                checkedColor="#3b90c4"
                                checked={this.state.isCheckForEagleOwners}
                                onPress={
                                  this.handlePressCheckedBoxForEagleOwners
                                }
                              />
                            </View>
                          </View>,
                          ...
                          <View>
                            <View
                              ...
                              <CheckBox
                                ...
                                center
                                checkedColor="#3b90c4"
                                checked={this.state.isCheckForNewJersey}
                          ...
                          <View>
                            <View
                              ...
                              <CheckBox
                                ...
                                center
                                checkedColor="#3b90c4"
                                checked={this.state.isCheckForJoplinCity}
                                onPress={
                                  this.handlePressCheckedBoxForjoplinCityNJChng
                                }
                              />
                            </View>
                          </View>,
                    ...
                    <View>
                      <TouchableOpacity
                        activeOpacity={0.5}
                        style={[
                          QuickQuotesStyle.CalculateButtonStyle,
                          {backgroundColor: 'red'},
                        ]}
                        onPress={() => this.onCallSaleSection()}>
                        <View>
                          <Text style={QuickQuotesStyle.CalculateTextStyle}>
                            {STRINGS.t('Quick_Quotes_Calculate')}
                          </Text>
                        </View>
                      </TouchableOpacity>
                    </View>
                      ...
                      <View style={QuickQuotesStyle.ResultMainContainerStyle}>
                        <View style={QuickQuotesStyle.ContainerStyle}>
                          <Text
                            ...
                            {STRINGS.t('Quick_Quotes_Owners_Policy')}
                          </Text>
                        </View>
                        {renderIf(this.state.showHawaiFields == false)(
                          <View style={QuickQuotesStyle.ContainerStyle}>
                            <Text
                              style={[
                                QuickQuotesStyle.TextStyle,
                                {width: '30%'},
                              ]}>
                              $ {this.delimitNumbers(this.state.ownerFee)}
                            </Text>
                            <Text
                              style={{
                                fontFamily: 'roboto-regular',
                          ...
                          <View style={QuickQuotesStyle.ContainerStyle}>
                            <View
                              ...
                              <View style={QuickQuotesStyle.flexrow}>
                                <Text style={QuickQuotesStyle.TextStyle}>
                                  ${' '}
                                  {this.delimitNumbers(
                                    this.state.ownerFeeHARPTABuyer,
                                  )}
                                </Text>
                                <Text
                                  style={{
                              ...
                              <View style={QuickQuotesStyle.flexrow}>
                                <Text
                                  ...
                                  ${' '}
                                  {this.delimitNumbers(
                                    this.state.ownerFeeHARPTASeller,
                                  )}
                                </Text>
                                <Text
                                  style={{
                        ...
                        <View style={QuickQuotesStyle.ContainerStyle}>
                          <Text
                            ...
                            {STRINGS.t('Quick_Quotes_Lender_Policy')}
                          </Text>
                        </View>
                        <View style={QuickQuotesStyle.ContainerStyle}>
                          <Text
                            ...
                            $ {this.delimitNumbers(this.state.lenderFee)}
                          </Text>
                          <Text
                            style={{
                              fontFamily: 'roboto-regular',
                        ...
                        <View style={QuickQuotesStyle.ContainerStyle}>
                          <Text
                            ...
                            {STRINGS.t('Quick_Quotes_Total_Escrow_Fee')}
                          </Text>
                        </View>
                        ...
                        <View style={QuickQuotesStyle.ContainerStyle}>
                          <View
                            ...
                            <View style={QuickQuotesStyle.flexrow}>
                              <Text style={QuickQuotesStyle.TextStyle}>
                                ${' '}
                                {this.delimitNumbers(this.state.escrowFeeBuyer)}
                              </Text>
                              <Text
                                style={{
                                  color: '#404040',
                          ...
                          <View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                {STRINGS.t('Quick_Quotes_Transfer_Tax')}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                $ {this.delimitNumbers(this.state.transferTax)}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                            ...
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                $ {this.delimitNumbers(this.state.harptaFee)}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                {STRINGS.t('Quick_Quotes_Attorney_Fee')}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                $ {this.delimitNumbers(this.state.attorneyFee)}
                              </Text>
                            </View>
                          </View>,
                        )}
                          ...
                          <View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                {STRINGS.t('Owner_Title_Serv_Charge')}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                ${' '}
                                {this.delimitNumbers(
                                  this.state.ownerServiceFeeJasper,
                                )}
                              </Text>
                              <Text
                                style={{
                                ...
                                {this.state.ownerServiceTypeJasper}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                {STRINGS.t('Lender_Title_Serv_Charge')}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                ${' '}
                                {this.delimitNumbers(
                                  this.state.loanServiceFeeJasper,
                                )}
                              </Text>
                              <Text
                                style={{
                                ...
                                {this.state.loanServiceTypeJasper}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                                ...
                                {STRINGS.t('Closing_Protection_Letter')}
                              </Text>
                            </View>
                            <View
                              style={[
                          ...
                          <View>
                            ...
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              ...
                              <Text
                                ...
                                {this.state.OwnerServChargeTitle}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                            ...
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              ...
                              <Text
                                ...
                                {this.state.LenderServChargeTitle}
                              </Text>
                            </View>
                            <View style={QuickQuotesStyle.ContainerStyle}>
                              <Text
                              ...
                              <View
                                ...
                                <View style={QuickQuotesStyle.flexrow}>
                                  <Text style={QuickQuotesStyle.TextStyle}>
                                    ${' '}
                                    {this.delimitNumbers(
                                      this.state.ClosingProtectionLetterBuyer,
                                    )}
                                  </Text>
                                  <Text
                                    style={{
                                ...
                                <View style={QuickQuotesStyle.flexrow}>
                                  <Text
                                    ...
                                    ${' '}
                                    {this.delimitNumbers(
                                      this.state.ClosingProtectionLetterSeller,
                                    )}
                                  </Text>
                                  <Text
                                    style={{
                ...
                <View>
                  ...
                  <View style={{flexDirection: 'column'}}>
                    <View style={{flexDirection: 'row', marginTop: 55}}></View>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <View style={QuickQuotesStyle.IndivTabTextInputViewStyle}>
                        ...
                        <CustomTextInput
                          ...
                          onChangeText={value =>
                            this.setState({
                              refineLoanAmount: this.onChange(value),
                            })
                          }
                    ...
                    <View style={QuickQuotesStyle.IndivTabContainer}>
                      ...
                      <View style={QuickQuotesStyle.IndivTabTextInputViewStyle}>
                        <CustomTextInput
                          ...
                          onKeyPress={() => this.onFocus('zip')}
                          onEndEditing={event =>
                            this.updateFormField(event.nativeEvent.text, 'zip')
                          }
                          placeholder="Zip Code (Optional)"
                          underlineColorAndroid={'transparent'}
                          onChangeText={value =>
                  ...
                  <View>
                    <TouchableOpacity
                      ...
                      onPress={() => this.onCallRefinanceSection()}>
                      <View>
                        <Text
                          style={{
                            color: '#ffffff',
                  ...
                  {this.state.orientation == 'portrait' ? (
                    <View style={{marginLeft: 5, marginTop: 25}}>
                      <View style={{marginTop: 10, flexDirection: 'row'}}>
                        <Text
                          style={{fontFamily: 'roboto-regular', width: '90%'}}>
                          {STRINGS.t('Title_Insurance')}
                        </Text>
                      </View>
                      <View style={{marginTop: 10, flexDirection: 'row'}}>
                        <Text
                          ...
                          $ {this.delimitNumbers(this.state.titleInsurance)}
                        </Text>
                        <Text
                          style={{fontFamily: 'roboto-regular', width: '60%'}}>
                          {this.state.titleInsuranceName}
                        </Text>
                      </View>
                      <View style={{marginTop: 10, flexDirection: 'row'}}>
                        <Text
                      ...
                      <View style={{marginTop: 10, flexDirection: 'row'}}>
                        <Text
                          ...
                          $ {this.delimitNumbers(this.state.refinEscrowFee)}
                        </Text>
                        <Text
                          style={{fontFamily: 'roboto-regular', width: '60%'}}>
                          {this.state.refinEscrowPolicyType}
                        </Text>
                      </View>
                    </View>
                  ) : (
                    <View style={{marginLeft: 5, marginTop: 25}}>
                      <View style={{marginTop: 10, flexDirection: 'row'}}>
                        <Text
                          style={{fontFamily: 'roboto-regular', width: '30%'}}>
                          {STRINGS.t('Title_Insurance')}
                        </Text>
                        <Text
                          style={{
      ...
      showable = (
        <MessageComponent
          ...
          cancelEmailPopup={this.cancelEmailPopup.bind(this)}
          textMsgPdfArray={this.state.textMsgPdfArray}
