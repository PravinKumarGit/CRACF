...
class Dashboard extends Component {
  ...
  VoiceNavigation() {
    ...
    if (this.state.partialResults != '') {
      ...
      buyer =
        matches.includes('buyer') ||
        matches.includes('Buyer') ||
        matches.includes('buy') ||
        matches.includes('bi') ||
        matches.includes('by') ||
        matches.includes('ba') ||
        matches.includes('bh') ||
        matches.includes('bie');;
      seller =
        matches.includes('sel') ||
        matches.includes('sal') ||
        matches.includes('sol') ||
        matches.includes('sail') ||
        matches.includes('chal') ||
        matches.includes('cel') ||
        matches.includes('col') ||
        matches.includes('hello');;
      refinance =
        matches.includes('ref') ||
        matches.includes('fin') ||
        matches.includes('free') ||
        matches.includes('reso') ||
        matches.includes('repu') ||
        matches.includes('nance');;
      netfirst =
        matches.includes('net') ||
        matches.includes('nut') ||
        matches.includes('et') ||
        matches.includes('nat') ||
        matches.includes('first') ||
        matches.includes('1st') ||
        matches.includes('fast') ||
        matches.includes('post');;
      quickQuotes =
        matches.includes('quick quotes') || matches.includes('Quick quotes');;
      addressBook =
        matches.includes('address book') || matches.includes('Address book');;
      settings =
        matches.includes('sett') ||
        matches.includes('set') ||
        matches.includes('sat');;
      language =
        matches.includes('language') ||
        matches.includes('Language') ||
        matches.includes('lang') ||
        matches.includes('pank');;
      account = matches.includes('account') || matches.includes('Account');;
      titlerep = matches.includes('title rep') || matches.includes('Title rep');;
      privacypolicy =
        matches.includes('privacy') || matches.includes('Privacy');
 ...
 handleFirstConnectivityChange(connectionInfo) {
  ...
  checkDefaultSettings() {
    ...
    callPostApi(
      GLOBAL.BASE_URL + GLOBAL.notify_for_setting_update,
      {userId: this.state.user_id, companyId: this.state.company_id},,
      ...
      if (result.data.showNotifyPopUp == 1) {
        AsyncStorage.getItem('newDateToCompare').then(value => {
          if  (value == 'null' || value == null) {
            Alert.alert('CostsFirst', mssge, [
              {text: 'REMIND ME LATER', onPress: this.onPressCancel.bind(this)},
              {text: 'UPDATE', onPress: this.updateDefaultSettings.bind(this)},
            ]);
          } else if (value == date) {
            Alert.alert('CostsFirst', mssge, [
              {text: 'REMIND ME LATER', onPress: this.onPressCancel.bind(this)},
  ...
  updateDefaultSettings() {
    ...
    callPostApi(
      GLOBAL.BASE_URL + GLOBAL.reload_user_setting,
      apiCallObjtemp,
      this.state.access_token,
    ).then(response => {
  ...
  onMultipleOfferPress() {
    this.props.navigator.push({
      name: 'SellerCalculator',
      params: 'multipleOffer',
      index: 0,
    });
  }
  onSellerPress() {
  ...
  onLogoutPress() {
    Alert.alert('CostsFirst', alertMessage, [
      {text: 'Cancel', onPress: () => console.log('Cancel Pressed!')},
      {text: 'OK', onPress: this.confirmlogout.bind(this)},
    ]);
  ...
  render() {
    ...
    if  (this.state.user_state_exist == true) {
      stateExists = (
        <View>
          <Text fontVariant="small-caps" style={{color: '#000000'}}>
            Set For : {this.state.user_county} County, {this.state.user_state}
          </Text>
        </View>;
      );
    } else {
    ...
    return (
      <View style={{flex: 1}}>
        <View style={dashboardStyle.iphonexHeader} />
        <Header />
        <View>
          {this.state.animating == 'true' ? <ShowActivityIndicator /> : null}
          <Text
            onPress={() => {
              this.setState({isVisible: true}), this.spring();
            }}
            style={{
            ...
            <Animated.View
              ...
              <View style={dashboardStyle.PopupContainer}>
                ...
                <View style={dashboardStyle.BottomButtonContainer}>
                  ...
                  <TouchableOpacity
                    style={dashboardStyle.ButtonBorder2}
                    onPress={() => {
                      this.setState({isVisible: false}), this.confirmlogout();
                    ;}}>
          ...
          <View style={dashboardStyle.PopupParent}>
            <View style={[dashboardStyle.BounceView]}>
              <View style={[dashboardStyle.PopupContainer, {minHeight: 200}]}>
                <Image
                  style={dashboardStyle.imageStyle}
                  source={Images.micIcon}
                />
                <Text>{this.state.speakTextStatus}</Text>
                <View style={dashboardStyle.BottomButtonContainer}>
                  <TouchableOpacity
                    style={dashboardStyle.ButtonBorder1}
                    onPress={() => {
        ...
        <ScrollView
          ...
          <View style={{padding: 7, flexDirection: 'row'}}>{stateExists}</View>
          <View style={{flexDirection: 'row'}}>
            <View
              style={
                this.state.buyerClosingCostBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onBuyerPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'buyerClosingCostBox',
                )}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(
                  this,
                  'buyerClosingCostBox',
                )}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.buyer_closing_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Buyer_Closing_Cost')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            <View
              style={
                this.state.sellerClosingCostBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.seller_closing_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Seller_Closing_Cost')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            <View
              style={
                this.state.multipleOfferBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }
              style={dashboardStyle.mainBoxStyle}>
              <TouchableHighlight
                onPress={this.onMultipleOfferPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'multipleOfferBox',
                )}
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.multiple_offer_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Seller_Multiple_Offer')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
          ...
          <View style={{flexDirection: 'row'}}>
            <View
              style={
                this.state.refinanceClosingCostBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onRefinancePress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'refinanceClosingCostBox',
                )}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(
                  this,
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.refinance_closing_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Refinance_Closing_Cost')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            ...
            <View
              style={
                this.state.rentVsBuyBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onRentVsBuyCalculatorPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(this, 'rentVsBuyBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(
                  this,
                  'rentVsBuyBox',
            ...
            <View
              style={
                this.state.netFirstBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onNetFirstPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(this, 'netFirstBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(this, 'netFirstBox')}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.net_first_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Net_First')}
                  </Text>
          ...
          <View style={{flexDirection: 'row'}}>
            <View
              style={
                this.state.quickQuotesBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onQuickQuotesPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'quickQuotesBox',
                )}
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.quick_notes_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
            ...
            <View
              style={
                this.state.addressBookBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onAddressBookPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'addressBookBox',
                )}
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.address_book_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Address_Book')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            ...
            <View
              style={
                this.state.settingsBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onAppSettingsPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(this, 'settingsBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(this, 'settingsBox')}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.app_setting_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Settings')}
                  </Text>
          ...
          <View style={{flexDirection: 'row'}}>
            <View
              ...
              <TouchableHighlight
                ...
                onHideUnderlay={this._onHideUnderlay.bind(this, 'languageBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(this, 'languageBox')}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.change_country_state_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Language')}
                  </Text>
            ...
            <View
              ...
              <TouchableHighlight
                ...
                onHideUnderlay={this._onHideUnderlay.bind(this, 'accBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(this, 'accBox')}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.my_account_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('My_Account')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            ...
            <View
              style={
                this.state.titleRepBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onMyTitleRepPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(this, 'titleRepBox')}
                underlayColor="#1683c0"
                onShowUnderlay={this._onShowUnderlay.bind(this, 'titleRepBox')}>
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.my_title_rep_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('My_Title_Rep')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
          ...
          <View style={{flexDirection: 'row'}}>
              ...
              <TouchableHighlight
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={
                      this.state.speakToTextVal
                        ? Images.speak_text_icon
                        : Images.speak_text_icon_unselected
                    }
                  />
                  <Text style={dashboardStyle.textStyle}>
                    {STRINGS.t('Speak_To_Text')}
                  </Text>
                </View>
              </TouchableHighlight>
            </View>
            ...
            <View
              style={
                this.state.privacyPolicyBox
                  ? dashboardStyle.mainBoxStyleOnpress
                  : dashboardStyle.mainBoxStyle
              }>
              <TouchableHighlight
                onPress={this.onPrivacyPolicyPress.bind(this)}
                onHideUnderlay={this._onHideUnderlay.bind(
                  this,
                  'privacyPolicyBox',
                )}
                ...
                <View style={dashboardStyle.touchableStyle}>
                  <Image
                    style={dashboardStyle.imageStyle}
                    source={Images.privacy_policy_icon}
                  />
                  <Text style={dashboardStyle.textStyle}>
            ...
            <View style={dashboardStyle.mainBoxStyle}>
              <TouchableHighlight
                onPress={() => {
                  this.setState({speakToTextBox: true}),
        ...
        <View style={dashboardStyle.iphonexFooter} />
      </View>
    );
  }
}
