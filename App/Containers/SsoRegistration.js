...
class SsoRegistration extends Component {
  ...
  callSaveUserApi() {
    ...
    callPostApi(
      GLOBAL.BASE_URL + GLOBAL.registerSingleSignOn,
      singleSignOnRequest,
    ).then(response => {
    ...
    return (
      <View style={loginStyles.backgroundImage}>
        ...
        <View style={signUpStyles.backgroundViewContainerSsoRegistration}>
          <Text style={signUpStyles.generalInfoStyleSsoRegistration}>
            {' '}
            {STRINGS.t('Sso_Title')}
          </Text>
          <Text style={signUpStyles.generalInfoStyleSsoRegistrationDes}>
            {' '}
            {STRINGS.t('Sso_Desciption')}
          </Text>
        </View>
        ...
        <ScrollView style={signUpStyles.keyboardContainerSsoRegistration}>
          <View style={signUpStyles.viewContainer}>
            ...
            {this.state.firstNameError != '' ? (
              <View style={signUpStyles.lineErrorView}></View>
            ) : (
              <View style={signUpStyles.lineView}></View>
            )}
            ...
            {this.state.stateError != '' ? (
              <View
                style={[signUpStyles.lineErrorView, {marginTop: 10}]}></View>
            ) : (
              <View style={[signUpStyles.lineView, {marginTop: 10}]}></View>
            )}
